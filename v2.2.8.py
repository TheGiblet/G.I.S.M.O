...
camera = Picamera2()
camera_config = camera.create_still_configuration(main={"size": (640, 480)})  # Set resolution
...
try:
    while True:
        ...
        # --- Camera functionality (using libcamera) ---
        image_path = '/home/pi/images/image.jpg'
        camera.capture_file(image_path)  # Capture an image
